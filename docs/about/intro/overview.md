...
Learn about dapplink and its primary features. {synopsis}

## What is dapplink

dapplink is a scalable, high-throughput Proof-of-Stake blockchain that is fully compatible and
interoperable with Ethereum. It's built using the [Cosmos SDK](https://github.com/cosmos/cosmos-sdk/) which runs on top of [Tendermint Core](https://github.com/tendermint/tendermint) consensus engine.

dapplink allows for running vanilla Ethereum as a [Cosmos](https://cosmos.network/)
...
Here’s a glance at some of the key features of dapplink:
...
dapplink enables these key features by:
...
| Property                     | Value                                                |
|------------------------------|------------------------------------------------------|
| dapplink Testnet                | `{{ $themeConfig.project.testnet_chain_id }}`        |
| dapplink Mainnet                | `{{ $themeConfig.project.chain_id }}`                |
| Blockchain Explorer(s)       | [dapplink.dev/tools/explorers](./../../developers/explorers.md) |
