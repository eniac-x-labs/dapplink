...
Learn about the encoding formats used on dapplink. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. dapplink does not
...
allows for quick reconstruction of encoded data. dapplink uses RLP to encode/decode Ethereum
