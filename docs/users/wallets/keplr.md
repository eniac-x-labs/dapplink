...
Connect your Keplr wallet with dapplink {synopsis}
...
Once you are signed in to the Keplr extension, you can connect the wallet with the dapplink network. The dapplink mainnet network is already built into Keplr; look for the `dapplink (beta)` network.
