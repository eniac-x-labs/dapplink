...
preparing test network with chain-id "dapplink_1276974-1"
...
```bash
dapplinkd keys add test --recover
```

Check the balance of the account address:

```bash
dapplinkd q bank balances [address]
```
