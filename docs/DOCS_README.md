...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/dapplink/dapplink/tree/main/CONTRIBUTING.md#updating-documentation)
...
The documentation for dapplink is hosted at [dapplink.dev](https://dapplink.dev/)

built from the files in this (`/docs`) directory for
[master](https://github.com/dapplink/dapplink/tree/main/docs).
