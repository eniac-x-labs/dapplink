...
// source: dapplink/vesting/v1/vesting.proto
...
func init() {
	proto.RegisterType((*ClawbackVestingAccount)(nil), "dapplink.vesting.v1.ClawbackVestingAccount")
}

func init() { proto.RegisterFile("dapplink/vesting/v1/vesting.proto", fileDescriptor_e18e121e13bc4d13) }
