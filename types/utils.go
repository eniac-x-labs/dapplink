...
const (
	// MainnetChainID defines the DappLink EIP155 chain ID for mainnet
	MainnetChainID = "dapplink_9001"
	// TestnetChainID defines the DappLink EIP155 chain ID for testnet
	TestnetChainID = "dapplink_9000"
)
...
// IsTestnet returns true if the chain-id has the DappLink testnet EIP155 chain prefix.
...
// GetDappLinkAddressFromBech32 returns the sdk.Account address of given address,
// while also changing bech32 human readable prefix (HRP) to the value set on
// the global sdk.Config (eg: `dapplink`).
