...
import (
	...
	"github.com/eniac-x-labs/dapplink/app"
	cmdcfg "github.com/eniac-x-labs/dapplink/cmd/config"
	dapplinkkr "github.com/eniac-x-labs/dapplink/crypto/keyring"
)
...
// NewRootCmd creates a new root command for dapplinkd. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(dapplinkkr.Option()).
		WithViper(EnvPrefix)

	rootCmd := &cobra.Command{
		Use:   app.Name,
		Short: "DappLink Daemon",
...
func (a appCreator) appExport(
	...
	if height != -1 {
		dapplinkApp = app.NewDappLink(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := dapplinkApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		dapplinkApp = app.NewDappLink(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}

	return dapplinkApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
